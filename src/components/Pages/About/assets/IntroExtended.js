  ...
  return (
    <article>
      ...
      <p>
        ...
        <cite>Udemy.com</cite>,{" "}
        <em>making sure I got my knowledge from diversified sources</em>, which
      ...
      <p>
        ...
        <cite>codesandbox.io</cite> to micro-practice new concepts, are a great
      ...
      <p>
        ...
        These projects were mainly developed in a team, usually 3-5 people, with
        the exception of the last year, which consisted on a solo project. This
        resulted in 4 years of multiple teamwork experiences with different
        people, which helped to lay the foundations of working collaborative in
        a harmonious way.
      </p>
...
export function IntroExtendedDE() {
  ...
  return (
    <article lang="de">
      ...
      <h4 id="knowledge">{knowledge}</h4>
      <p>
        Ich habe einige Bücher über JavaScript gelesen aber den Großteil meines
        Wissens habe ich mir aus Online-Ressourcen angeeignet. So konnte ich die
        Theorie direkt mit der Praxis verbinden.
      </p>
      <p>
        Für einen strukturierteren Ansatz habe ich mich bei verschiedenen
        Online-Kursen von Udemy.com eingeschrieben, um sicherzustellen, dass ich
        mein Wissen von verschiedenen Experten beziehe.
      </p>
      <p>
      ...
      <p>
        ...
        dieser Website finden können, war ein sehr gutes Training und so konnte
        ich die Theorie in die Praxis umsetzten. Herausforderungen waren dabei
        eine gute Übung für mich, die richtige Lösung zu finden.
      </p>
      <p>
      ...
      <p>
        Zusätzlich löse ich gerne regelmäßig Challenges, um meine Fähigkeiten zu
        testen und zu verbessern. Hauptsächlich nutze ich <cite> Edabit </cite>{" "}
      ...
      <h4 id="study">{study}</h4>
      <p>
        Ich habe Soziologie studiert. Thematisch und technisch gesehen, trägt es
        nicht all zu viel zum Bereich Webentwicklung bei, allerdings war der
        Ablauf des Studiums sehr projektorientiert angelegt, so dass ich in der
        Zeit schon Erfahrungen im Bereich Projektarbeit sammeln konnte. Diese
        Projekte wurden hauptsächlich in einem Team bearbeitet, normalerweise
        3-5 Personen, mit Ausnahme des letzten Jahres, welches aus einem
        Soloprojekt bestand. Dies führte zu 4 Jahren starker Teamarbeit, in
        denen ich viele Erfahrungen in der Zusammenarbeit mit verschiedenen
        Menschen sammeln konnte.
      </p>
