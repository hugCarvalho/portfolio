...
export function IntroMainEN() {
  return (
    <article>
      ...
      <p>
        Hi, I'm Hugo, a self-taught web developer, with a master in Sociology. I started
        to learn Programming with JavaScript, alongside my job, about one and half year
        ago. It started as a curiosity but didn't take long to turn into a passion.
        Recently, I decided to quit my job to pursue this passion.
      </p>
      <p>
      ...
      <p>
        ...
        towards a common goal with the objective of achieving something that will impact
        positively people's lives. This would also bring a sense of realization to my
        learning process.
      </p>
